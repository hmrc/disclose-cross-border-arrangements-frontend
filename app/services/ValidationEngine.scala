...
//                  (implicit hc: HeaderCarrier, ec: ExecutionContext) : Future[Either[Exception, UploadValidationResult]] = {
//
//    try {
//      val xmlAndXmlValidationStatus: (Elem, UploadValidationResult) = performXmlValidation(downloadUrl)
...
//  }
//
//  private def combineResults(xmlResult: UploadValidationResult, businessRulesResult: UploadValidationResult,
//                             metaDataResult: UploadValidationResult): UploadValidationResult = {
//
...
// }
//
//  def performXmlValidation(source: String): (Elem, UploadValidationResult) = {
//
...
//                                    (implicit hc: HeaderCarrier, ec: ExecutionContext): Future[UploadValidationResult] = {
//
