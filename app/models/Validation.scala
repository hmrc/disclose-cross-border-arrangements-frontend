...
case class Validation(key: String, value: Boolean, lineNumber: Option[Int] = None) {
  ...
  def setLineNumber(xmlArray: Array[String]): Validation ={
   ...
   def getErrorMessage: String ={
     key match {
       ...
       case "businessrules.RelevantTaxPayersBirthDates.maxDateOfBirthExceeded" => "Check BirthDate field is on or after 1 January 1903 for all RelevantTaxPayers"
       case "businessrules.DisclosingBirthDates.maxDateOfBirthExceeded" => "Check BirthDate field is on or after 1 January 1903 for Disclosing"
       case "businessrules.IntermediaryBirthDates.maxDateOfBirthExceeded" => "Check BirthDate field is on or after 1 January 1903 for all intermediaries"
       case "businessrules.AffectedPersonsBirthDates.maxDateOfBirthExceeded" => "Check BirthDate field is on or after 1 January 1903 for all AffectedPersons"
       case "businessrules.AssociatedEnterprisesBirthDates.maxDateOfBirthExceeded" => "Check BirthDate field is on or after 1 January 1903 for all AssociatedEnterprises"
  ...
  def path: String = {
    ...
    key match {
      ...
      case "businessrules.initialDisclosureMA.allRelevantTaxPayersHaveTaxPayerImplementingDate" => "RelevantTaxPayers"
